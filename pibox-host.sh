...
# Ask user if they want to copy keys from pi to root
# Default to yes
echo "On initial setup of PiBox app, the 'pi' user will be deleted for security."
read -p "Copy SSH keys from pi to root to retain remote access? (Y/n) " -n 1 -r
echo
